...
if ($_POST['button'] == "Submit Request") {
	...
	$subject_to_vendor = "New Client registration";
	
	// Check if any required field is blank
	if (!$name || !$client_email || !$address|| !$country || !$username || !$password || !$verifypass) 
	{
		...
		header("Location: ?err_msg=Please fill in all required fields which are marked with an asterisk (*)");
			...
			$result = mysql_query("INSERT INTO client_data(name, company, email, website, address, country, phone, username, password) values('$name','$company','$client_email','$website','$address','$country','$phone','$username','$password')");
		...
		<table style='border-collapse:collapse; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px'>
		  ...
		  <tr>
			...
			<td style='padding:5px; border:1px solid lightgray; background-color:#e3e3e3;'>Website</td>
...
<title>Client Registration | Pictorep</title>
</head>
...
<table width="100%" border="0" cellspacing="5" cellpadding="0" bgcolor="#e6e4da">
  ...
  <tr>
  <td colspan="2"><h4>Pictorep client registration form</h4><p>All fields are required</p></td>
  </tr>
  <tr>
   ...
   <tr>
    <td width="142"><label for="company">Company Name</label></td>
    <td width="265"><input type="text" name="company" id="company" size="34" /></td>
  </tr>
  <tr>
   ...
   <tr>
    ...
    <td width="265"><input type="text" name="website" id="website" size="34" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="center"colspan="2"><input type="submit" id="button" name="button" value="Submit Request"/></td>
  </tr>
  <tr>
  </tr>
</table>
